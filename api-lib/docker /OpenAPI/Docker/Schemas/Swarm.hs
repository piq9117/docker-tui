...
module OpenAPI.Docker.Schemas.Swarm where
...
import OpenAPI.Docker.Schemas.JoinTokens
...
data Swarm = Swarm
    {
        ...
        joinTokens :: (Data.Maybe.Maybe (JoinTokens)),
...
instance Data.Aeson.ToJSON Swarm where
    toJSON Swarm {..} = Data.Aeson.object
        ([ 
        ]
        ...
        ++ [ "JoinTokens" Data.Aeson..= joinTokens | Just joinTokens <- [joinTokens] ]
    ...
    toEncoding Swarm {..} = Data.Aeson.Encoding.pairs
        ( maybe mempty (Data.Aeson.Encoding.pair "CreatedAt" . Data.Aeson.toEncoding) createdAt <>
          ...
          maybe mempty (Data.Aeson.Encoding.pair "JoinTokens" . Data.Aeson.toEncoding) joinTokens <>
