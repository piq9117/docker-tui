...
module OpenAPI.Docker.Schemas.Resources where
...
instance Data.Aeson.ToJSON ResourcesBlkioWeightDevice where
    toJSON ResourcesBlkioWeightDevice {..} = Data.Aeson.object
        ([ 
        ]
        ++ [ "Path" Data.Aeson..= path | Just path <- [path] ]
        ++ [ "Weight" Data.Aeson..= weight | Just weight <- [weight] ])

    toEncoding ResourcesBlkioWeightDevice {..} = Data.Aeson.Encoding.pairs
...
instance Data.Aeson.FromJSON ResourcesBlkioWeightDevice where
    parseJSON = Data.Aeson.withObject "ResourcesBlkioWeightDevice" $ \o ->
...
instance Data.Aeson.ToJSON ResourcesUlimits where
    toJSON ResourcesUlimits {..} = Data.Aeson.object
        ([ 
        ]
    ...
    toEncoding ResourcesUlimits {..} = Data.Aeson.Encoding.pairs
...
instance Data.Aeson.FromJSON ResourcesUlimits where
    parseJSON = Data.Aeson.withObject "ResourcesUlimits" $ \o ->
        ResourcesUlimits
            <$> o Data.Aeson..:? "Hard"
            <*> o Data.Aeson..:? "Name"
            <*> o Data.Aeson..:? "Soft"
...
data Resources = Resources
    {
        ...
        blkioWeightDevice :: (Data.Maybe.Maybe ([ ResourcesBlkioWeightDevice ])),
        ...
        ulimits :: (Data.Maybe.Maybe ([ ResourcesUlimits ]))
    }
    deriving (Show)

instance Data.Aeson.ToJSON Resources where
    toJSON Resources {..} = Data.Aeson.object
        ([ 
        ]
    ...
    toEncoding Resources {..} = Data.Aeson.Encoding.pairs
...
instance Data.Aeson.FromJSON Resources where
    parseJSON = Data.Aeson.withObject "Resources" $ \o ->
        Resources
